...
int main() {
  ...
  // Use clCreateBuffer() to create a buffer object (d_C) with enough space to hold the output data
  ...
  // Use clEnqueueReadBuffer() to read the OpenCL output buffer (bufferC) to the host output array (C)
